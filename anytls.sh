...
DOWNLOAD_URL="https://github.com/anytls/anytls-go/releases/download/v0.0.13/anytls_0.0.13_linux_${BINARY_ARCH}.zip"
ZIP_FILE="/tmp/anytls_0.0.13_linux_${BINARY_ARCH}.zip"
...
[Service]
ExecStart=$BINARY_DIR/$BINARY_NAME -l 0.0.0.0:62333 -p $PASSWORD
Restart=always
User=root
Group=root
...
EOF
    ...
    echo -e "\033[32m√ 监听端口: 0.0.0.0:62333\033[0m"
    ...
    echo -e "\033[30;43m\033[1m anytls://$PASSWORD@$SERVER_IP:62333/?insecure=1 \033[0m"
